...
public class Main {
    ...
    static int anzahlVisitor = 500;
    static int anzahlExtraEmployees = 40; //Jeder Zoo hat mind. ein Angestellten
    static int anzahlExtraTickets = 500; //Jeder Besucher hat mind. ein Ticket
